...
const POPULATE = [
  ...
  'populate[sections][on][sections.hero][populate]=heroImage',
  'populate[sections][on][sections.logo-cloud][populate][logos][populate]=image',
  'populate[sections][on][sections.feature-blocks][populate][items][populate]=image',
  'populate[sections][on][sections.testimonials][populate]=items',
  'populate[sections][on][sections.final-cta][populate]=*',
].join('&');
