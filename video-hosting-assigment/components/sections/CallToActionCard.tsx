...
export default function CallToActionCard({
  ...
  return (
    <section className="py-24 sm:w-full md:w-3/4 lg:w-2/3 justify-center mx-auto lg:py-32">
      <div className="section-container">
        <div className="relative overflow-hidden rounded-3xl gradient-cta px-8 py-20 text-center sm:px-16 lg:px-24 lg:py-28">
          ...
          <div className="relative">
            ...
            {data.subheadline && (
              <p className="mx-auto mt-6 text-lg text-white/70 lg:text-xl">
                {data.subheadline}
              </p>
            )}
            {data.ctaLabel && data.ctaHref && (
              <div className="mt-10 flex flex-col items-center gap-4 sm:flex-row sm:justify-center">
                <Button
                  ...
                  size="lg"
                  variant="secondary"
                  className="h-12  px-8  font-semibold shadow-lg transition-all hover:shadow-xl hover:scale-105"
                >
                  <a href={data.ctaHref}>
                    {data.ctaLabel}
                    <ArrowRight />
