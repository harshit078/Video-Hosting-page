        ...
        <div className="grid gap-12 lg:grid-cols-6">
          ...
          <div className="lg:col-span-2">
            ...
            <p className="mt-4 text-sm leading-relaxed text-muted-foreground">
              The modern video hosting platform for businesses. Fast, secure, and reliable streaming for your content.
            </p>
            {/* Social links */}
            <div className="mt-6 flex gap-4">
              <a href="#" className="rounded-lg p-2 text-muted-foreground transition-colors hover:bg-white hover:text-primary hover:shadow-sm">
